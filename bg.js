...
function enableGPUAcceleration() {
    const elements = document.querySelectorAll('.section-background, #background-canvas, #blur-overlay');
    elements.forEach(el => {
...
function initMaterial() {
    if (material && material.uniforms) {
        ...
        material.uniforms.dispMap.value = new THREE.TextureLoader().load('assets/displacement/5.jpg', requestRender);
    }
}
