...
(function() {
    ...
    const images = ['s11_a1.png'];　                                          　//他プロジェクトはここ差し替え必要
    ...
    function updateRendererSize() {
        const imageWrapper = document.getElementById('project11-image-wrapper'); 　//他プロジェクトはここ差し替え必要
    ...
    function loadTextures() {
        ...
        Promise.all(images.map(img => new Promise(resolve => {
            loader.load(`assets/pr_11/${img}`, texture => {　　//他プロジェクトはここ差し替え必要
                resolve(texture);
            }, undefined, error => {
                resolve(null);
            });
            ...
            loader.load('assets/pr_11/1.png', 　　　　　　　//他プロジェクトはここ差し替え必要
                texture => {
                    dispTexture = texture;
                    createMaterial();
                },
